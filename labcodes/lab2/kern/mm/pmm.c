...
get_pte(pde_t *pgdir, uintptr_t la, bool create) {
    ...
    if (!(*pdep & PTE_P)) {         // (2) check if entry is not present
    	if(!create || (page = alloc_page()) == NULL) return NULL;	// (3) check if creating is needed, then alloc page for page table
